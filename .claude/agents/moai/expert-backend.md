...
skills: moai-foundation-claude, moai-lang-python, moai-lang-typescript, moai-lang-javascript, moai-domain-backend, moai-domain-database, moai-platform-supabase, moai-platform-neon, moai-platform-gcp, moai-tool-ast-grep
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
